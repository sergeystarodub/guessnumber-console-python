...
class GuessNumber():
    ...
    def NumberPlayers(self):    # метод для задания количества игроков и их имен
    ...
    def RandomNumber(self):     # метод для случайного генерирования числа, которое нужно угадать-сложность задается диапазоном конечного числа
        while True:
            try:
    ...
    def NumberMoves(self):      # метод сложности игры - ограничение на количество попыток угадывания числа
    ...
    def main(self):
        ...
        while True:
            ...
            # вызов метода сложности - ограничения количества ходов
            ...
            while (flag == 0):
                ...
                # если moves is None то в методе NumberMoves() выбрали вариант без сложности и далее данный код выполнять не надо, если со сложностью - код отработает
                if (moves is None):
                    continue
                else:
                    moves -= 1
